...
System.out.println("The file " +file_name+ " is not writeable");
              ...
              System.out.println("The path of"+file_name+":"+f.getPath());
              System.out.println("The  Absolute path of"+file_name+":"+f.getAbsolutePath());
              System.out.println("The Hidden path of"+file_name+":"+f.isHidden());
